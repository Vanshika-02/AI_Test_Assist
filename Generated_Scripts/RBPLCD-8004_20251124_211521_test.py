...
def test_rbplcd_8004(page: Page):
    ...
    expect(page.get_by_text("default_Measurement01", exact=False)).to_be_visible()
    ...
    # Text verification (L3 Vision)
    expect(page.get_by_text("Id", exact=False)).to_be_visible()
