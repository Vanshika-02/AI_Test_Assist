...
def test_rbplcd_8001(page: Page):
    ...
    # Wait for element to be available
    page.wait_for_selector("[data-shareddetailview='expansionPanel']", timeout=10000)

    # Click action
    page.click("[data-shareddetailview='expansionPanel']")
    page.wait_for_load_state('networkidle')
    print("[OK] Clicked element")
    ...
    step_results.append({
        ...
        'selector': "[data-shareddetailview='expansionPanel']",
        'agent_used': 'L1',
        'confidence': 0.77,
        'status': 'PASSED'
    })
    ...
    # Selector discovered by: Agent L1 (confidence: 0.81)
    # Action type: click
    ...
    step_results.append({
        ...
        'selector': "[data-attributegroupattribute='Type']",
        'agent_used': 'L1',
        'confidence': 0.81,
        'status': 'PASSED'
    })
