...
//   constructor(private jiraService: JiraService, private apiService: ApiService, private msalService: MsalService) {}
...
//   this.loading = true;
//   this.error = '';
//   this.jiraService.getTicket(this.jiraTicketId.trim()).subscribe({
//     next: (data) => {
...
//   private fetchTicketAndGenerate(ticketId: string) {
//     this.jiraService.getTicket(ticketId).subscribe({
//      next: (ticketDetails) => {
//       this.loading = false;
